...
<section class="vbox">
	<section class="scrollable wrapper">
		<form action="{:U('Article/editDraft')}" method="post" enctype="multipart/form-data" id="addlog" name="addlog">
				...
				<section class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="text-center">
							...
							<input type="submit" name="submit" id="savedf" value="发布" onclick="return checkform();" class="btn btn-success" />
						</div>
					</div>
				</section>
			</div>
