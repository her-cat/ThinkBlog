...
class Page{
    ...
    public function show() {
        ...
        if(empty($this->url)){
            ...
            $this->url = rtrim(U('/' . $this->url, '', false), $depr) .  $depr . urlencode('[PAGE]') . $this->getKeyword();
        }
        /* 计算分页信息 */
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page <= $this->totalPages){
                    $link_page .= '<a href="' . $this->url($page) . '" title="' . $page . '"><span class="page">' . $page . '</span></a>';
                }else{
                    break;
                }
            }else{
    ...
    private function getKeyword(){
        return $this->parameter['keyword'] == '' ? '' : '?keyword=' . $this->parameter['keyword'];
    }
}
