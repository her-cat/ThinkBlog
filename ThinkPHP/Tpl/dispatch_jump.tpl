...
body{ background: #fff; font-family: '微软雅黑'; color: #CCC; font-size: 16px; }
 ...
 .system-message .success,.system-message .error{ line-height: 1.8em;  color: #999; font-size: 23px; font-family: '黑体'; }
 .system-message .detail{ font-size: 12px; line-height: 20px; margin-top: 12px; display:none}
 </style>
 <script src="__PUBLIC__/Js/jquery-1.12.1.min.js" type="text/javascript"></script>
...
<h1 class="glyphicon glyphicon-ok-circle" style="color:green"></h1>
